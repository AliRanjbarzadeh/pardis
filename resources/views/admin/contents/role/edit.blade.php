						...
						<div class="card mb-3">
							<div class="card-body">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="name" name="name" placeholder="@lang('admin/role.placeholders.name')" value="{{ old('name', $role->name) }}"/>
								</div>
							</div>
						</div>
											...
											<div class="d-flex flex-wrap">
												@foreach($permissionCategory->permissions as $permission)
													<div class="form-check me-3 mb-2 mb-md-0">
														<input class="form-check-input" type="checkbox" name="permissions[perm-{{ $permission->id }}]" value="{{ $permission->id }}" id="permission-{{ $permission->id }}" data-permission-category="{{ $permissionCategory->id }}" @checked(old("permissions.perm-$permission->id", $role->hasPermission($permission->id)))>
													...
													<div class="mt-3">
														...
														<div class="d-flex flex-wrap">
															@foreach($firstChild->permissions as $firstPermission)
																<div class="form-check me-3 mb-2 mb-md-0">
																	<input class="form-check-input" type="checkbox" name="permissions[perm-{{ $firstPermission->id }}]" value="{{ $firstPermission->id }}" id="permission-{{ $firstPermission->id }}" data-permission-category="{{ $permissionCategory->id }}" @checked(old("permissions.perm-$firstPermission->id", $role->hasPermission($firstPermission->id)))>
															...
															<div class="mt-3">
																...
																<div class="d-flex flex-wrap">
																	@foreach($secondChild->permissions as $secondPermission)
																		<div class="form-check me-3 mb-2 mb-md-0">
																			<input class="form-check-input" type="checkbox" name="permissions[perm-{{ $secondPermission->id }}]" value="{{ $secondPermission->id }}" id="permission-{{ $secondPermission->id }}" data-permission-category="{{ $permissionCategory->id }}" @checked(old("permissions.perm-$secondPermission->id", $role->hasPermission($secondPermission->id)))>
																...
																<div class="mt-3">
																	...
																	<div class="d-flex flex-wrap">
																		@foreach($thirdChild->permissions as $thirdPermission)
																			<div class="form-check me-3 mb-2 mb-md-0">
																				<input class="form-check-input" type="checkbox" name="permissions[perm-{{ $thirdPermission->id }}]" value="{{ $thirdPermission->id }}" id="permission-{{ $thirdPermission->id }}" data-permission-category="{{ $permissionCategory->id }}" @checked(old("permissions.perm-$thirdPermission->id", $role->hasPermission($thirdPermission->id)))>
