				...
				<div class="d-flex align-items-end row">
					<div class="col-sm-7">
						<div class="card-body">
							...
							<p class="mb-4">شما انجام داده اید
								<span class="fw-bold">72%</span> فروش بیشتر امروز نشان جدید خود را در نمایه خود بررسی کنید.
							</p>
				...
				<div class="col-lg-6 col-md-12 col-6 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<h3 class="card-title mb-1">12,628<span style="font-size: 14px">تومان</span>
							</h3>
				...
				<div class="col-lg-6 col-md-12 col-6 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<span>فروش</span>
							<h3 class="card-title text-nowrap mb-1">4,679<span style="font-size: 14px">تومان</span>
							</h3>
						...
						<div class="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-between">
							<div class="d-flex">
								...
								<div class="d-flex flex-column">
									<small>1400</small>
									<h6 class="mb-0">32.5<span style="font-size: 14px">  تومان</span>
									</h6>
								</div>
							</div>
							<div class="d-flex">
								...
								<div class="d-flex flex-column">
									<small>1399</small>
									<h6 class="mb-0">41.2<span style="font-size: 14px"> تومان</span>
									</h6>
								</div>
							</div>
						</div>
				...
				<div class="col-6 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<h3 class="card-title text-nowrap mb-2">2,456<span style="font-size: 14px">تومان</span>
							</h3>
				...
				<div class="col-6 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<h3 class="card-title mb-2">14,857<span style="font-size: 14px">تومان</span>
							</h3>
							...
							<div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
								<div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
									...
									<div class="mt-sm-auto">
										...
										<h3 class="mb-0">84,686<span style="font-size: 14px">تومان</span>
										</h3>
									</div>
								</div>
							...
							<div class="d-flex p-4 pt-3">
								...
								<div>
									...
									<div class="d-flex align-items-center">
										<h6 class="mb-0 me-1">459.10<span style="font-size: 14px">تومان</span>
										</h6>
