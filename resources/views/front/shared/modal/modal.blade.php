	...
	@switch($popup->type->value)
		@case('text')
			<section id="popup" class="modal p-5 fixed top-1/4 z-[999999999] w-11/12 md:w-[55vw] xl:w-[40vw] inset-x-0 mx-auto bg-white rounded-lg">
				...
				<div class="leading-8 max-h-[30vh] overflow-y-auto">{{ $popup->description }}</div>
		...
		@case('image')
			<section id="banner-popup" class="modal banner-modal fixed top-1/4 z-[999999999] w-11/12 md:w-[55vw] xl:w-[40vw] inset-x-0 mx-auto rounded-lg overflow-hidden">
				<img src="{{ $popup->feature_image->url }}" class="w-full h-full object-cover object-center" alt="">
