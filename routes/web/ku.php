...
//blogs
Route::get('شێرپەنجە', [BlogController::class, 'cancer']);
...
//about
Route::get('دەربارەی-ئێمە', [CommonController::class, 'about'])->name('about');

//contact
Route::prefix('پەیوەندیمان-پێوەبکە')->name('contact.')->group(function () {
